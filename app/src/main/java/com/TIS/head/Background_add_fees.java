...
public class Background_add_fees extends AsyncTask<String,Void,String> {
    Context context;
    String url_insert="https://tisabcd12.000webhostapp.com/head/adding_fees.php";

    public Background_add_fees(Context context) {
    ...
    protected String doInBackground(String... strings) {
        ...
        String start_date=strings[4];
        String end_date=strings[5];
