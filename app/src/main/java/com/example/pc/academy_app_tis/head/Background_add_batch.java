...
public class Background_add_batch extends AsyncTask<String,Void,String> {
    Context context;
    String url_insert="https://tisabcd12.000webhostapp.com/head/Adding_Batch.php";

    public Background_add_batch(Context context) {
