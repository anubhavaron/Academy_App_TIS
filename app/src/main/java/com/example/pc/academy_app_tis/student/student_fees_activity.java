...
public class student_fees_activity extends AppCompatActivity implements com.example.pc.academy_app_tis.head.fees_adapter.fees_adapterOnClickHandler {
    ...
    {   String json_url="https://tisabcd12.000webhostapp.com/head/getting_fees.php?batch_subject="+ student_batch.subject_s+"&batch_class="+student_batch.class_s+"&batch_number="+student_batch.number_s+"&username="+Student_Navigation.username;
